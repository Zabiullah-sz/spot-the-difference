...
export class DrawingAreaComponent implements OnInit {
    ...
    onMouseDown(e: MouseEvent): void {
        ...
        if (this.selectedToolService.selectedTool instanceof PaintFill) {
            this.selectedToolService.selectedTool.onMouseDownWithContext({ x: e.offsetX, y: e.offsetY }, context);
        } else {
