...
import { MatchSettingDialogComponent } from './match-setting-dialog.component';
import SpyObj = jasmine.SpyObj;

describe('MatchSettingDialogComponent', () => {
    let component: MatchSettingDialogComponent;
    let fixture: ComponentFixture<MatchSettingDialogComponent>;
    let dialogRefSpy: SpyObj<MatDialogRef<MatchSettingDialogComponent>>;
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            declarations: [MatchSettingDialogComponent, PaperButtonComponent],
            providers: [
        ...
        fixture = TestBed.createComponent(MatchSettingDialogComponent);
